...
recovered_state = 3;
dead_state = 9;
infected_quarantine_state = 10; %goes to 14 
susceptible_quarantine_state = 16; %goes to 20
         ...
         for col = 2:cols + 1
             ...
             elseif (cell_value(row - 1, col - 1) > 0 && ...
                ...
                if cell_value(row - 1, col - 1) == recovered_state+...
                   length_of_immunity || ...
                   cell_value(row - 1, col - 1) == ...
                   infected_quarantine_state + length_of_immunity || ...
                   cell_value(row - 1, col - 1) == ...
                   susceptible_quarantine_state + length_of_infection
